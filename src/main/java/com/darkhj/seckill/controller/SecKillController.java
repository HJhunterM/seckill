package com.darkhj.seckill.controller;

import com.darkhj.seckill.common.ResponseEntity;
...
public class SecKillController {
    ...
    public ResponseEntity<GetGoodsInfoData> getGoodsInfo(@RequestHeader("Trace-ID") String traceID, @RequestHeader("User-ID") Long userID, @RequestParam(name = "goodsNum") String goodsNum) {
    ...
    public ResponseEntity<GetGoodsListData> getGoodsList(@RequestHeader("Trace-ID") String traceID, @RequestHeader("User-ID") Long userID, @RequestParam(name = "offset") Integer offset, @RequestParam(name = "limit") Integer limit) {
        if (limit == 0) {
            limit = 200;
        }
    ...
    public ResponseEntity<String> secKillV1(@RequestHeader("Trace-ID") String traceID, @RequestHeader("User-ID") Long userID, @RequestBody SecKillV1Req data) {
        String orderNum = "";
        //try {
    ...
    public ResponseEntity<String> secKillV2(@RequestHeader("Trace-ID") String traceID, @RequestHeader("User-ID") Long userID, @RequestBody SecKillV1Req data) {
        String orderNum = "";
        try {
            String goodsNum = data.goodsNum;
            Integer num = data.num;
    ...
    public ResponseEntity<String> secKillV3(@RequestHeader("Trace-ID") String traceID, @RequestHeader("User-ID") Long userID, @RequestBody SecKillV1Req data) {
        String secNum = "";
        try {
            String goodsNum = data.goodsNum;
            Integer num = data.num;
